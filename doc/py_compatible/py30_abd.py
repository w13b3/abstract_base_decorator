...
_WRAPPER_ASSIGNMENTS = tuple(functools.WRAPPER_ASSIGNMENTS) + ('__code__',)


def callable(object  # type: callable
             ):
    # type: (...) -> bool
    """Return True if the object argument appears callable, False if not.
    https://docs.python.org/3/library/functions.html?callable#callable
    """
